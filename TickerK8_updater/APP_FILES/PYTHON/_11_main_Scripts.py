...
#_______________________________________________________________________________________________________________________
    ...
    def check_updates(self):
        try: # Try check and setup update if is.
            github_version = None
            response = urllib.request.urlopen('https://api.github.com/repos/CodeNestGroup/TickerK8-MacOS/releases/latest') # Open latest update from github
...
#_______________________________________________________________________________________________________________________
    ...
    def get_releses(self):
        try: # Try open url, debug
            try: # Try connect
                response = urllib.request.urlopen('https://api.github.com/repos/CodeNestGroup/TickerK8-MacOS/releases') # Get latest relaeses from github
